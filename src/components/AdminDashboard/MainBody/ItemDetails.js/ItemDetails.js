...
const ItemDetails = () => {
  ...
  return (
    <>
      ...
      <div className="h-[90%] w-full flex flex-col justify-between items-center bg-gray-50 rounded-b-xl">
        <div className="h-[90%] w-full flex justify-around ">
          <div className="w-1/3 h-[100%] ">
            <div className="w-full h-4/5 py-1">
              <img
            ...
            <div className="h-1/5 w-full flex grig grid-cols-3 gap-1 overflow-x-scroll ">
              <img
                src={selectedItem.image}
