      ...
      <div className="container mx-auto flex items-center justify-between h-[6vh] ">
        ...
        <div className="flex justify-center items-center gap-[25px] ">
          <div>
            <input
              type="search"
              className="form-input py-2 px-3 block w-full rounded-full transition duration-150 ease-in-out bg-white border border-gray-300 placeholder-gray-500  focus:outline-none focus:shadow-outline-blue focus:border-blue-300 placeholder-opacity-25"
              placeholder="Search..."
            />
          </div>
          <div
